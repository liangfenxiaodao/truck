class Listing
  ...
  def initialize(price, goods, transport, bid_ending_time, vehicle_requirement, customer)
    @price = price
    @goods = goods
    @transport = transport
  ...
  def self.all
    ...
    user1 = User.new 'Jacky Li', true
    user2 = User.new 'Thomas Wu', true
    ...
    listing1 = Listing.new('75', goods1, transport1, '2014-03-12T18:00:00', vehicle_requirement1, user1)
    listing2 = Listing.new('70', goods2, transport2, '2014-03-12T18:00:00', vehicle_requirement2, user2)
    listing3 = Listing.new('72', goods3, transport3,  '2014-03-12T18:00:00', vehicle_requirement3, user2)
    listing4 = Listing.new('60', goods4, transport4, '2014-03-12T18:00:00', vehicle_requirement4, user2)
